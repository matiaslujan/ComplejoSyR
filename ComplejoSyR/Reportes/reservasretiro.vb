...
Public Class reservasretiro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ComplejoSolYRio.reservasretiro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreservasretiro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reservasretiro = New reservasretiro
        rpt.Site = Me.Site
        Return rpt
    End Function
